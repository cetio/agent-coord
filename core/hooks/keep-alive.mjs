...
const lines = recessState.active
    ? [
        ...
        "3. Keep the turn alive with wait_for_message (60000 ms). A quiet wait is normal; a timeout is not a reason to stop.",
        "",
    ...
    : [
        ...
        "   (60000 ms), then go back to 1. A quiet wait is normal; a parked seat is not.",
        "",
