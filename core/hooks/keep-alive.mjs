...
const lines = recessState.active
    ? [
        ...
        "3. Keep the turn alive with wait_for_message (your stagger — short, never near 60s) on your INBOX — @mentions fan out there,",
        ...
        "   you have something non-redundant — a quiet agent is fine, a reply-chorus is not.",
        "",
    ...
    : [
        ...
        "",
        agent ? `You are ${agent}. What "not idling" means here:` : `What "not idling" means here:`,
